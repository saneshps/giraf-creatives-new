...
<head>
  ...
  <title> Website & Mobile App,E-commerce,Design Development Company,India|Giraf Creatives</title>
  <!-- canonical -->
  <link href="https://girafcreatives.com/in/web-and-app-development.php" rel="canonical">
  <!--// canonical -->
...
<body>
  ...
  <section class="services-list-area serv-detail">
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- Unicorns -->
        <div class="col-xl-12 col-lg-12 col-md-12 services-list unicorns" data-aos="fade-right" data-aos-duration="2000">
          <div class="row justify-content-space-evenly">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 services-list-box serv-detail-space">
              <img src="./img/services/web/app-installation-animate.svg" alt="app">
            </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 services-list" data-aos="fade-right" data-aos-duration="2000">
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 services-list-box serv-detail-space serv-detail-flex">
              ...
              <p> It's about cracking the code on usability, accessibility and eye candy.
                A well structured website can reap the best benefits. Inspirational to every visitor,
                our websites offer next level euphoric experience with tough fundamentals and design choices.
              </p>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 services-list" data-aos="fade-left" data-aos-duration="2000">
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 services-list-box serv-detail-space serv-detail-flex">
              ...
              <p> Your search for best app developers ends here, our ability to create user friendly,
                fast n efficient apps are loved by many businesses.
                Experience the power of app tech to skyrocket your dreams.
  ...
  <!-- ===================================
       ...
       =================================== -->
  <section class="individualy-area">
    <div class="container">
      <div class="row">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      if (window.innerWidth <= 768) {
        ...
        if (aos) {
          desktopStylesheet.parentNode.removeChild(aos);
        }
      }
    });
  </script>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'New Message From Giraf Creatives De';
            // $mail->Body = '
            ...
            //             </tr>
            //         </table>
            //         <p style="margin-top:30px;font-size:12px;color:#888;">This message was sent from the contact form on <a href="https://girafcreatives.com/de" style="color:#0066cc;">girafcreatives.com/de/</a>.</p>
            //     </div>
            // ';

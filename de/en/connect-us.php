    ...
    <div class="container">
      <div class="row box-commn justify-content-center align-items-center">
        <div class="col-xl-6 col-lg-7 col-md-12 address-from-first">
          ...
          <h4> Give us a call to learn more about <br> how we can help you stand apart. </h4>
        ...
        <div class="col-xl-9 col-lg-10 col-md-12 address-from">
          <div class="form-bg">
            <div class="form-container">
                ...
                <br>
                <br>
                <button type="submit" name="subc" class="btn btn-default" style="top: 10px;"> Get in Touch <i class="fas fa-angle-right"></i> </button>
              </form>
            </div>
          </div>

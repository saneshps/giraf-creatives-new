...
<head>
  ...
  <!-- canonical -->
  <link href="https://girafcreatives.com/de/service-details.php" rel="canonical">
  <!--// canonical -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-5 col-lg-5 col-md-12 portfolio-details-first">
          <img src="./img/services/service-details-1.jpg" alt="Service">
        </div>
        <div class="col-xl-7 col-lg-7 col-md-12 portfolio-details-second">
          <h2> Yes Machinery </h2>
          <h3> York Engineering Solutions FZC - UAE </h3>
